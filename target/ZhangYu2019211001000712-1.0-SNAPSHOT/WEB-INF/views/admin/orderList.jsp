		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.ZhangYu.model.Order o=(com.ZhangYu.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.ZhangYu.dao.UserDao userDao=new com.ZhangYu.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.ZhangYu.model.Payment.findByPaymentId(con,n);
						%>
